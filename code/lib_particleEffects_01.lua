...
function AttachSparks(emitterName)
	Particles.DetachParticleTypes(emitterName)
	Particles.AttachParticleType (emitterName, "LightSmoke"		, 10, 1500,0) 
	Particles.AttachParticleType (emitterName, "ElectricSparks"	, 40, 1500,0) 
	Particles.AttachParticleType (emitterName, "ExplosionFlash"	,  5, 1500,0) 
